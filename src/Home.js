        ...
        <div className='flex flex-col md:flex-row w-full h-screen md:pt-32'>
          <div className='w-full md:w-1/2 pt-32'>
            <div className='text-center md:text-start'>
              <h2 className="text-2xl md:text-6xl font-thin">I'm PauloNkelego</h2>
            </div>
            <div className='mt-3 md:mt-5 text-md md:text-lg'>
              ...
              <div className='text-violet-600 mt-12 md:mt-8 flex justify-center md:justify-start text-2xl space-x-6'>
                ...
                <a href='#'><FaClock className='hover:text-black'/></a>
              </div>
          ...
          <div className='flex flex-wrap justify-center w-full md:w-1/2'>
            <div className='px-10 md:mt-3 md:w-3/4'>
              <img src={image} width={600} height={100} alt="Portfolio image" className='mt-20 mb-40 rounded-full ring-1 ring-gray-300'/>
            </div>
          </div>
        </div>

        {/* second flex */}
        <div className="w-full text-center mt-32 md:mt-0">
